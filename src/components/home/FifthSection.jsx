    ...
    <div className="bg-black">
      <Wrapper>
        <div className="flex flex-col lg:flex-row justify-center items-center lg:h-[673px] ">
          <div className="w-full flex flex-col gap-5 lg:gap-12 lg:w-[45%] px-[20px] py-7 lg:px-[58px] bg-[#000000] min-h-full text-white justify-center">
            <h1 className="text-5xl lg:text-h1 decrese_space gotham flex items-center gap-7 ">
              <span>SEARCH BY TIRES</span>
          ...
          <img
            src="/images/home/third.svg"
            alt=""
            className="w-full h-full lg:w-[57%] object-cover"
          />
        </div>
      </Wrapper>
    </div>
